...
public class PeptideController {
	...
	@PreAuthorize("hasRole('USER')")
	public List<Peptide> getAllPeptidesNotComplexity(
			@PathVariable(value = "complexity") SampleTypeComplexity complexity) {
	...
	public Peptide updatePeptide(@RequestBody Peptide peptide, @PathVariable String peptideSequence) {
		return peptideService.updatePeptide(peptide, peptideSequence);
	}
