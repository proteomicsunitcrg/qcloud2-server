...
public class SampleTypeCategoryController {
	...
	public SampleTypeCategory getSampleTypeCategoryByApiKey(@PathVariable UUID sampleTypeCategoryApiKey) {
		Optional<SampleTypeCategory> stc = sampleTypeCategoryService
				.getSampleTypeCategoryByApiKey(sampleTypeCategoryApiKey);
		if (stc.isPresent()) {
			return stc.get();
		} else {
	...
	public void addSampleTypeToSampleTypeCategory(@PathVariable Long sampleTypeCategoryId,
	...
	public void removeSampleTypeFromSampleTypeCategory(@PathVariable Long sampleTypeCategoryId,
			@RequestBody SampleType sampleType) {
