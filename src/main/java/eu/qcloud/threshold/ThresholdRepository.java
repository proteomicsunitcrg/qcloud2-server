...
public interface ThresholdRepository<T extends Threshold> extends CrudRepository<T, Long> {
	...
	public Optional<Threshold> findOptionalBySampleTypeIdAndParamIdAndInstrumentIdAndLabSystemIdAndIsEnabledTrue(
			Long sampleTypeId, Long paramId, Long cvId, Long labSystemId);

	public withParamsWithoutThreshold findBySampleTypeIdAndParamIdAndInstrumentIdAndLabSystemId(Long sampleTypeId,
			Long paramId, Long cvId, Long labSystemId);

	public Optional<Threshold> findOptionalBySampleTypeIdAndParamIdAndInstrumentIdAndIsEnabledTrue(Long sampleTypeId,
			Long paramId, Long cvId);

	public Optional<Threshold> findOptionalBySampleTypeQualityControlControlledVocabularyAndParamQccvAndInstrumentQccv(
	 ...
	 * @return
	 */
	public Optional<Threshold> findOptionalBySampleTypeQualityControlControlledVocabularyAndParamQccvAndInstrumentQccvAndLabSystemApiKeyIsNull(
			String sampleTypeQCCV, String paramQCCV, String instrumentQCCV);

	public Optional<Threshold> findOptionalBySampleTypeQualityControlControlledVocabularyAndParamQccvAndInstrumentQccvAndLabSystemApiKeyAndIsEnabledTrue(
			String sampleTypeQCCV, String paramQCCV, String instrumentQCCV, UUID labSystemApiKey);
	 ...
	 * @return
	 */
	public Optional<Threshold> findOptionalBySampleTypeIdAndParamIdAndInstrumentIdAndIsEnabledTrueAndLabSystemIdIsNull(
			Long sampleTypeId, Long paramId, Long cvId);

	public withParamsWithoutThreshold findBySampleTypeIdAndParamIdAndInstrumentIdAndIsEnabledTrue(Long sampleTypeId,
			Long paramId, Long cvId);
	...
	public List<Threshold> findAllDefaultThresholdsByThresholdCVIdAndSampleTypeIdAndParamId(Long cvId,
			Long sampleTypeId, Long paramId);

	@Query("select t from Threshold t where t.labSystem = null and t.instrument.id = ?1 and t.sampleType.id = ?2 and t.param.id = ?3")
	public Optional<Threshold> findDefaultThresholdByThresholdCVIdAndSampleTypeIdAndParamId(Long cvId,
			Long sampleTypeId, Long paramId);
	...
	public ThresholdForPlot findByParamIdAndSampleTypeIdAndLabSystemId(Long paramId, Long sampleTypeId,
			Long labSystemId);

	@Query("select t from Threshold t where t.param.id = ?1 and t.sampleType.id = ?2 and t.labSystem.id = ?3 and t.isEnabled = 1")
	public Threshold findThresholdByParamIdAndSampleTypeIdAndLabSystemId(Long paramId, Long sampleTypeId,
			Long labSystemId);

	@Query("select t from Threshold t where t.sampleType.id = ?1 and t.labSystem.id = ?2 and t.isEnabled = 1")
	public Optional<List<Threshold>> findThresholdBySampleTypeIdAndLabSystemId(Long sampleTypeId,
			Long labSystemId);
	 ...
	 * @return
	 */
	public List<Threshold> findByLabSystemApiKeyAndSampleTypeQualityControlControlledVocabulary(UUID labSystemApiKey,
