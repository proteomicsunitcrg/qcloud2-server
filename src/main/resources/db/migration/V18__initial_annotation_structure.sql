...
--
-- Table structure for table `non_conformity_problem_actions`
--

DROP TABLE IF EXISTS `non_conformity_problem_actions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `non_conformity_problem_actions` (
  `problem_id` bigint(20) NOT NULL,
  `actions_id` bigint(20) NOT NULL,
  KEY `FKhwwfwa878xxi8ytnyk8q57ej4` (`actions_id`),
  KEY `FKag85h8gli9lgjpfj3qtbkndar` (`problem_id`),
  CONSTRAINT `FKag85h8gli9lgjpfj3qtbkndar` FOREIGN KEY (`problem_id`) REFERENCES `non_conformity_problem` (`id`),
  CONSTRAINT `FKhwwfwa878xxi8ytnyk8q57ej4` FOREIGN KEY (`actions_id`) REFERENCES `non_conformity_action` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `non_conformity_problem_reasons`
--

DROP TABLE IF EXISTS `non_conformity_problem_reasons`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `non_conformity_problem_reasons` (
  `problem_id` bigint(20) NOT NULL,
  `reasons_id` bigint(20) NOT NULL,
  KEY `FKjvxxt5vgmbjj6i32u1sikb8bx` (`reasons_id`),
  KEY `FKlmrq96afg9103br998oknibov` (`problem_id`),
  CONSTRAINT `FKjvxxt5vgmbjj6i32u1sikb8bx` FOREIGN KEY (`reasons_id`) REFERENCES `non_conformity_reason` (`id`),
  CONSTRAINT `FKlmrq96afg9103br998oknibov` FOREIGN KEY (`problem_id`) REFERENCES `non_conformity_problem` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
