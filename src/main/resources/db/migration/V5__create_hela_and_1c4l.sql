...
INSERT INTO `sample_type` VALUES (4,_binary '','hela','QC:0000006',2),(5,_binary '','qc4l','QC:0000009',3);

/*!40000 ALTER TABLE `sample_type` ENABLE KEYS */;
UNLOCK TABLES;
LOCK TABLES `sample_seq` WRITE;
update `sample_seq` set next_val = 6;
UNLOCK TABLES;
...
-- Dump completed on 2018-10-01 11:10:27
