...
INSERT INTO `category` VALUES (1,_binary '!Y�HZ�Df���G?\0',1,'Mass spectrometer'),(2,_binary '@%�_�(H��}}Xw!',0,'Liquid chromatographer');
...
INSERT INTO `chart` VALUES (1,_binary '\"b�J��I?�Y`��w\0',0,0,'Peptide area',75,1),(2,_binary 'FA��nOW��J�M��\0',0,1,'Mass accuracy',75,1),(3,_binary ' ��*B�j��J��V\0',0,0,'Miit',75,1),(4,_binary 'm�L��J������',0,0,'Median IT MS2',48,1),(5,_binary '{��k�AB�6R(�`�',0,1,'Totals',75,1),(6,_binary 'm�V�#N����H�d',0,0,'Mass accuracy',75,4);
...
INSERT INTO `context_source` VALUES ('peptide',1,'LVN',_binary '�:?	/Jj���L�Zr\0','LVNELTEFAK',NULL,2,582.319,'LVNELTEFAK'),('peptide',2,'HLV',_binary '�?�*�E����_�J��\0','HLVDEPQNLIK',NULL,2,653.362,'HLVDEPQNLIK'),('peptide',3,'VPQ',_binary '��]3��L�^|�rd��','VPQVSTPTLVEVSR',NULL,2,756.425,'VPQVSTPTLVEVSR'),('peptide',4,'EAC',_binary '�2�`�N��4�3\0','EAC(Carbamidomethyl)FAVEGPK',NULL,2,554.261,'EAC(Carbamidomethyl)FAVEGPK'),('peptide',5,'EYE',_binary '�K��0F?���u�\0\0','EYEATLEEC(Carbamidomethyl)C(Carbamidomethyl)AK',NULL,2,751.811,'EYEATLEEC(Carbamidomethyl)C(Carbamidomethyl)AK'),('peptide',6,'ECC',_binary '?4v�HM����W?k�\0\0','EC(Carbamidomethyl)C(Carbamidomethyl)HGDLLEC(Carbamidomethyl)ADDR',NULL,3,583.892,'EC(Carbamidomethyl)C(Carbamidomethyl)HGDLLEC(Carbamidomethyl)ADDR'),('peptide',7,'SLH',_binary '\'����-J���\'X:v��','SLHTLFGDELC(Carbamidomethyl)K',NULL,2,710.35,'SLHTLFGDELC(Carbamidomethyl)K'),('peptide',8,'TCV',_binary 'y+���%@a���a��,\0','TC(Carbamidomethyl)VADESHAGC(Carbamidomethyl)EK',NULL,3,488.534,'TC(Carbamidomethyl)VADESHAGC(Carbamidomethyl)EK'),('peptide',9,'YIC',_binary '�`�!�M�>�Q=3�U','YIC(Carbamidomethyl)DNQDTISSK',NULL,2,722.325,'YIC(Carbamidomethyl)DNQDTISSK'),('peptide',10,'NEC',_binary '����H2�_�^�)\\?','NEC(Carbamidomethyl)FLSHK',NULL,2,517.74,'NEC(Carbamidomethyl)FLSHK'),('instrument_sample',11,'miit ms1',_binary '�����D��h��rQ�','Median IT MS1','QC:1000927',NULL,NULL,NULL),('instrument_sample',12,'Median IT MS2',_binary '�\'#	�@\0���w�Y��','Median IT MS2','QC:1000928',NULL,NULL,NULL),('instrument_sample',13,'# proteins',_binary '�[6Q�F6�j�/�O5','Total number of identified proteins','QC:0000032',NULL,NULL,NULL),('instrument_sample',14,'# peptides',_binary '	x�/[�C3���;��V','Total number of uniquely identified peptides','QC:0000031',NULL,NULL,NULL),('instrument_sample',15,'MS2 spectral count',_binary 'x8��Fv�nel��?\0\0','MS2 Spectral count','QC:0000007',NULL,NULL,NULL),('instrument_sample',16,'# psm',_binary '���&#G?#B ��?\0\0','Total number of PSM','QC:0000029',NULL,NULL,NULL),('peptide',17,'YAE',_binary '*�=6CE?�O@gcG��','YAEAVTR',NULL,2,405.211,'YAEAVTR'),('peptide',18,'TPA',_binary '?06s\"O��?)�	�E\0\0','TPAQFDADELR',NULL,2,631.804,'TPAQFDADELR'),('peptide',19,'STL',_binary '?,��F��O��?\0\0','STLTDSLVC(Carbamidomethyl)K',NULL,2,562.287,'STLTDSLVC(Carbamidomethyl)K'),('peptide',20,'SLA',_binary '9Z��@%I���c$x�','SLADELALVDVLEDK',NULL,2,815.433,'SLADELALVDVLEDK'),('peptide',21,'NPD',_binary 'I���G\\����=���','NPDDITNEEYGEFYK',NULL,2,917.394,'NPDDITNEEYGEFYK'),('peptide',22,'LGD',_binary '4HE98A\Z��FJ��','LGDLYEEEMR',NULL,2,627.787,'LGDLYEEEMR'),('peptide',23,'LAV',_binary '!�a��JN��:��?�','LAVDEEENADNNTK',NULL,2,781.352,'LAVDEEENADNNTK'),('peptide',24,'FEE',_binary '��\n�D�J����?����','FEELNMDLFR',NULL,2,657.313,'FEELNMDLFR'),('peptide',25,'EAA',_binary '�R~�\r�LY�����[�','EAALSTALSEK',NULL,2,560.298,'EAALSTALSEK'),('peptide',26,'DDV',_binary 'c)�J?���kA\Z�\0','DDVAQTDLLQIDPNFGSK',NULL,2,988.484,'DDVAQTDLLQIDPNFGSK'),('peptide',27,'RFP',_binary '�4�KvJN���?��\0','RFPGYDSESK',NULL,2,593.28,'RFPGYDSESK'),('peptide',28,'EVS',_binary '�M���E?{s�v��\'\0','EVSTYIK',NULL,2,420.229,'EVSTYIK'),('peptide',29,'EAT',_binary '�r�21\"D6�;�T\"p]','EATTEFSVDAR',NULL,2,613.288,'EATTEFSVDAR'),('peptide',30,'FAF',_binary '�1E��OW���eZ���\0','FAFQAEVNR',NULL,2,541.275,'FAFQAEVNR'),('peptide',31,'EQF',_binary '�\'U�8J�����]��\0','EQFLDGDGWTSR',NULL,2,705.818,'EQFLDGDGWTSR'),('peptide',32,'YVY',_binary '9mWY3&L���*6ha0','YV(Heavy)YV(Heavy)ADV(Heavy)A(Heavy)A(Heavy)K(Heavy)',NULL,2,566.83,'YV(Heavy)YV(Heavy)ADV(Heavy)A(Heavy)A(Heavy)K(Heavy)'),('peptide',33,'YVY',_binary '�W�$`J��!�`C�','YV(Heavy)YV(Heavy)ADV(Heavy)AAK(Heavy)',NULL,2,562.823,'YV(Heavy)YV(Heavy)ADV(Heavy)AAK(Heavy)'),('peptide',34,'YVY',_binary '�P�G�\\A?�1����\0','YVYV(Heavy)ADV(Heavy)AAK(Heavy)',NULL,2,559.816,'YVYV(Heavy)ADV(Heavy)AAK(Heavy)'),('peptide',35,'YVY',_binary 'g8��jK?\0\'n���\0','YVYVADV(Heavy)AAK(Heavy)',NULL,2,556.809,'YVYVADV(Heavy)AAK(Heavy)'),('peptide',36,'YVY',_binary '��<v?F?��?r\0\0\0\0\0','YVYVADVAAK(Heavy)',NULL,2,553.802,'YVYVADVAAK(Heavy)'),('peptide',37,'LLS',_binary '�S\\�,IGd��	���wK','L(Heavy)L(Heavy)SL(Heavy)GAGEF(Heavy)K(Heavy)',NULL,2,537.344,'L(Heavy)L(Heavy)SL(Heavy)GAGEF(Heavy)K(Heavy)'),('peptide',38,'LLS',_binary '���ZFI���p����','L(Heavy)L(Heavy)SL(Heavy)GAGEFK(Heavy)',NULL,2,532.331,'L(Heavy)L(Heavy)SL(Heavy)GAGEFK(Heavy)'),('peptide',39,'LLS',_binary 'zST�M�A0�/T�t?�','L(Heavy)L(Heavy)SLGAGEFK(Heavy)',NULL,2,528.822,'L(Heavy)L(Heavy)SLGAGEFK(Heavy)'),('peptide',40,'LLS',_binary '��g�x@������4\0','L(Heavy)LSLGAGEFK(Heavy)',NULL,2,525.313,'L(Heavy)LSLGAGEFK(Heavy)'),('peptide',41,'LLS',_binary '���@YH)�HN����','LLSLGAGEFK(Heavy)',NULL,2,521.805,'LLSLGAGEFK(Heavy)'),('peptide',42,'LGF',_binary '��P-yM+�����?�\0','L(Heavy)GF(Heavy)TDL(Heavy)F(Heavy)SK(Heavy)',NULL,2,535.328,'L(Heavy)GF(Heavy)TDL(Heavy)F(Heavy)SK(Heavy)'),('peptide',43,'LGF',_binary '[K�DB���?QU�\0','L(Heavy)GFTDL(Heavy)F(Heavy)SK(Heavy)',NULL,2,530.315,'L(Heavy)GFTDL(Heavy)F(Heavy)SK(Heavy)'),('peptide',44,'LGF',_binary '�!����H��?S�4��','L(Heavy)GFTDL(Heavy)FSK(Heavy)',NULL,2,525.301,'L(Heavy)GFTDL(Heavy)FSK(Heavy)'),('peptide',45,'LGF',_binary '�b���O�Q�?�7\0','L(Heavy)GFTDLFSK(Heavy)',NULL,2,521.792,'L(Heavy)GFTDLFSK(Heavy)'),('peptide',46,'LGF',_binary '��v��C��#��(','LGFTDLFSK(Heavy)',NULL,2,518.284,'LGFTDLFSK(Heavy)'),('peptide',47,'VTS',_binary '�?��YM?�t�����\0','V(Heavy)T(Heavy)S(Heavy)GST(Heavy)ST(Heavy)SR(Heavy)',NULL,2,509.274,'V(Heavy)T(Heavy)S(Heavy)GST(Heavy)ST(Heavy)SR(Heavy)'),('peptide',48,'VTS',_binary 'Zf5D���U��G','V(Heavy)T(Heavy)SGSTST(Heavy)SR(Heavy)',NULL,2,504.765,'V(Heavy)T(Heavy)SGSTST(Heavy)SR(Heavy)'),('peptide',49,'VTS',_binary '�??N1���;Wf��\0\0','V(Heavy)T(Heavy)SGSTSTSR(Heavy)',NULL,2,502.26,'V(Heavy)T(Heavy)SGSTSTSR(Heavy)'),('peptide',50,'VTS',_binary '�B�l>�I?�b��G�\0','V(Heavy)TSGSTSTSR(Heavy)',NULL,2,499.755,'V(Heavy)TSGSTSTSR(Heavy)'),('peptide',51,'VTS',_binary '4so�DB����?�N�\0','VTSGSTSTSR(Heavy)',NULL,2,496.748,'VTSGSTSTSR(Heavy)'),('peptide',52,'VVG',_binary '��?TH(�g%?�N\0\0\0','V(Heavy)V(Heavy)GGL(Heavy)V(Heavy)ALR(Heavy)',NULL,2,459.823,'V(Heavy)V(Heavy)GGL(Heavy)V(Heavy)ALR(Heavy)'),('peptide',53,'VVG',_binary 'jDN*@=����W��','V(Heavy)V(Heavy)GGLV(Heavy)ALR(Heavy)',NULL,2,456.315,'V(Heavy)V(Heavy)GGLV(Heavy)ALR(Heavy)'),('peptide',54,'VVG',_binary '�0+9�*A��E�[p�?\0','V(Heavy)V(Heavy)GGLVALR(Heavy)',NULL,2,453.308,'V(Heavy)V(Heavy)GGLVALR(Heavy)'),('peptide',55,'VVG',_binary '��?H�N��\'�?�\0�\0\0','V(Heavy)VGGLVALR(Heavy)',NULL,2,450.301,'V(Heavy)VGGLVALR(Heavy)'),('peptide',56,'VVG',_binary '��3���N�dgbm}}\0','VVGGLVALR(Heavy)',NULL,2,447.294,'VVGGLVALR(Heavy)'),('peptide',57,'LAS',_binary '��E��>G?���9D�\0','L(Heavy)A(Heavy)SV(Heavy)SV(Heavy)S(Heavy)R(Heavy)',NULL,2,428.274,'L(Heavy)A(Heavy)SV(Heavy)SV(Heavy)S(Heavy)R(Heavy)'),('peptide',58,'LAS',_binary '7��>B�.,�\nS\0','L(Heavy)ASV(Heavy)SV(Heavy)SR(Heavy)',NULL,2,424.267,'L(Heavy)ASV(Heavy)SV(Heavy)SR(Heavy)'),('peptide',59,'LAS',_binary '�(K���H�����GDg','LASV(Heavy)SV(Heavy)SR(Heavy)',NULL,2,420.758,'LASV(Heavy)SV(Heavy)SR(Heavy)'),('peptide',60,'LAS',_binary '��3f\nwF@��J?%\0\0','LASVSV(Heavy)SR(Heavy)',NULL,2,417.751,'LASVSV(Heavy)SR(Heavy)'),('peptide',61,'LAS',_binary 'k+��J{D��M���','LASVSVSR(Heavy)',NULL,2,414.744,'LASVSVSR(Heavy)');
...
INSERT INTO `data_source` VALUES (2,_binary 'o�k���M��xI%Re',1,'Lumos',75,1),(3,_binary '��8Bo E}��[;��',1,'Proxeon 3',93,1),(4,_binary '���yH<���5�',1,'XL',48,1),(5,_binary 'd.Yh`hHe��5��0�',1,'Velos',79,1),(6,_binary ':?FL��uxo�P\0\0',1,'Proxeon 2',93,1),(7,_binary '?\0���G��CR?�K�\0\0',1,'Proxeon 1',94,1);
...
INSERT INTO `guide_set` VALUES ('automatic',1,_binary '���[�B���S{|]z','2018-08-13 02:07:00',1,'2018-08-11 13:57:00',10,1),('manual',2,_binary '�-zn[�F?�N���\0','2018-09-10 23:59:00',1,'2018-09-03 00:00:00',NULL,1);
...
INSERT INTO `labsystem` VALUES (1,_binary '�����O\Z�\'�/v5�','Lumos'),(2,_binary '�C��:G��*%e�r�','XL'),(3,_binary '%?�( ?Fe����?\0\0','Velos');
...
INSERT INTO `node` VALUES (1,_binary '$��js�K?:?9X�\0\0\0','CRG',NULL),(8,_binary '�5�{�lJ��f���^','EMBL',NULL),(9,_binary 'c\n9�B��$�R�','EMbiel','Germany');
...
INSERT INTO `sample_type_category` VALUES (1,_binary '���+�\rK9�\'�?�\0\0','QC1',0),(2,_binary 'U��TMM��]�	#��','QC2',1),(3,_binary '�V;W?J?2�/�H�\0\0\0','QC3',2);
...
INSERT INTO `threshold` VALUES ('hard_limit',1,_binary '=�����G?8aa��\0',1,1,NULL,1,75,NULL,2,1),('sigmalog2',2,_binary 'T�\0e�vH?4�j�\Z�\0',1,1,NULL,3,75,NULL,1,1),('sigma',3,_binary 'uCV�6M%�i��?K\0',1,1,NULL,3,75,NULL,3,1),('hard_limit',4,_binary '��>�WA���ui/v�\Z',0,1,NULL,1,75,1,2,1),('sigmalog2',5,_binary '�^�yn�HF�$�*�!�',1,1,NULL,3,75,1,1,1),('sigma',6,_binary '��Ax\rH��K���;�X',1,1,NULL,3,75,1,3,1),('hard_limit',7,_binary '�R�# Co��.@R��',1,1,NULL,1,48,NULL,2,1),('hard_limit',8,_binary '��n�OUC&���}T�g',0,1,NULL,1,75,1,2,1),('hard_limit',9,_binary '?J{^JS��u?��\0\0\0',1,1,NULL,1,75,1,2,1),('hard_limit',10,_binary 'WB����JZ��\�\Z<\�p�',1,1,NULL,1,48,2,2,1);
...
INSERT INTO `user` VALUES (1,_binary 'L�G��E?����$�\0\0','daniel.mancera@crg.eu',_binary '','Daniel','2018-09-27 10:14:00.366000','Mancera','$2a$10$wSusaymX0lMIdQ16faI93u1t5RtvjmoreLpiw1vfyuZ/YxeKf7YkW','daniel.mancera@crg.eu',1,4),(7,_binary '�2E3`Kz�*��6Y�@','dmance@edpac.org',_binary '','Danie','2018-10-02 13:10:36.595000','Daniel','$2a$10$L1rXTuxLidUXH9T65raJRuePIDT7Hqcx3NbgQKuizJqvdX6jHQDVi','dmance@edpac.org',8,NULL),(8,_binary '���5@|�?�}��\0\0','mister@mister.om',_binary '','se?orrr','2018-10-03 12:04:13.326000','s?orrr','$2a$10$oZCzS0EVHOcfVQiK3Dn0ou0adbXD.roaSNwvoohyf5AACkijiO2Pe','mister@mister.om',9,NULL);
...
INSERT INTO `view` VALUES (1,_binary '_Q?K�O��W�O7^',1,'QC1',75,1,NULL),(2,_binary '�l>?�C7��!���S6\0',1,'QC2',75,2,NULL);
